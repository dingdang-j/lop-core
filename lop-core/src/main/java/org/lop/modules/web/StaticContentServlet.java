...
public class StaticContentServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 7782750766540987030L;
	...
	protected void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
		...
		// 只能访问static目录.
		else if ( !StringUtils.startsWith( contentPath, "static" ) ) {
			response.sendError( HttpServletResponse.SC_FORBIDDEN, "contentPath parameter prefix is static." );
			return;
		}
