package org.lop.modules.cache.memcached;
...
public class SpyMemcachedClient implements DisposableBean {
	 ...
	 * Incr方法.
	 * 
	 * @see net.spy.memcached.MemcachedClient#incr(String, int, long)
	 */
	 ...
	 * Decr方法.
	 * 
	 * @see net.spy.memcached.MemcachedClient#decr(String, int, long)
	 */
	 ...
	 * 
	 * @see net.spy.memcached.MemcachedClient#asyncIncr(String, int)
	 */
	 ...
	 * 
	 * @see net.spy.memcached.MemcachedClient#asyncDecr(String, int)
	 */
