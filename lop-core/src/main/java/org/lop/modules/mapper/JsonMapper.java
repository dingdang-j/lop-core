package org.lop.modules.mapper;
...
public class JsonMapper {
	...
	/**
	 * 当JSON里只含有Bean的部分属性时, 更新一个已经存在Bean, 只覆盖该部分的属性.
	 */
	...
	/**
	 * 设定是否使用Enum的toString()来读写Enum, 为false时使用Enum的name()来读写Enum, 默认为false.
	 * 
	 * 注意本方法一定要在Mapper创建后, 所有读写动作之前调用.
	 */
