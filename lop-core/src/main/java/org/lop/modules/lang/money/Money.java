package org.lop.modules.lang.money;
...
public class Money implements Serializable, Comparable<Object> {
	 ...
	 */
	private static final long serialVersionUID = 1207482765549019700L;
	 ...
	 * 
	 * <p>
	 * 创建一个具有金额<code>amount</code>元和指定币种<code>currency</code>的货币对象。 如果金额不能转换为整数分，则使用指定的取整模式
	 ...
	 * 
	 * <p>
	 * 创建一个具有参数<code>amount</code>指定金额和缺省币种的货币对象。 如果金额不能转换为整数分，则使用指定的取整模式 <code>roundingMode</code>
	 * 取整。
	 * 
	 * @param amount
	 *            金额，以元为单位。
	 ...
	 *                待比较货币对象不是<code>Money</code>。 IllegalArgumentException 待比较货币对象与本货币对象的币种不同。
	 * 
